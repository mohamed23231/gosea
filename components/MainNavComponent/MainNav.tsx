  ...
  return (
    <nav className="flex w-full items-center justify-between px-6 h-16 bg-white text-gray-700 border-b border-gray-200 z-10">
      <div className="flex items-center mb-4">
        <button className="ml-2" aria-label="Open Menu" onClick={handleDrawer}>
          <GiHamburgerMenu className="text-3xl" />
        </button>
        <span
          style={{ backgroundColor: "#F2F4F7" }}
          className="h-20 w-20 rounded-full flex items-center mx-2"
        >
          <img src="/gosea.png" alt="Logo" className="h-auto w-24" />
        </span>
      ...
      >
        <span className="flex w-full items-center p-4 border-b">
          <img src="/gosea.png" alt="Logo" className="h-auto w-32 mx-auto" />
        </span>
