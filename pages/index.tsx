...
function Home() {
  ...
  return (
    <>
      <h2 className=" font-bold	my-5 text-2xl	text-slate-500 ml-5	">GoSea</h2>
      ...
      {isLoading ? (
        ...
        <div className="w-full">
          <div className="home-content-parent flex flex-col lg:flex-row justify-center">
            <div className="company-list lg:min-w-96 flex flex-col overflow-y-auto max-h-screen scrollbar-thin overflow-x-hidden"></div>
            <div className="company-list sm:w-full lg:w-2/3 "></div>
          </div>
        </div>
      )}
    </>
